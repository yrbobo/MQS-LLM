...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default='dataset/CHQ-Summ/test/test.json')
    ...
    parser.add_argument("--model_path", type=str, default='models/Meta-Llama-3.1-8B-Instruct')
